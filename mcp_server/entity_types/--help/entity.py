...
class HelpEntity(BaseModel):
    ...
    **Task:** Identify and extract information about Products mentioned in the provided text context.
    HelpEntity represents a specific good or service that a company offers.

    **Context:** The user will provide text containing potential mentions of --helps.
    ...
    **Extraction Instructions:**
    ...
    4.  **Extract Category:** Determine the --help category (e.g., "Software", "Hardware", "Service") based on the description or explicit mentions.
    ...
    **Output Format:** Respond with the extracted data structured according to this Pydantic model.
    ...
    name: str = Field(
        ...,
        description='The specific name of the --help as mentioned in the text.',
    )
    description: str = Field(
        ...,
        description='A concise description of the --help, synthesized *only* from information present in the provided text context.',
    )
    category: str = Field(
        ...,
        description='The category the --help belongs to (e.g., "Electronics", "Software", "Service") based on the text.',
    ) 